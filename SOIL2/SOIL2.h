...
public:
    ...
    QOpenGLFunctions_4_1_Compatibility* m_pGlobalGLCore = nullptr;
...
void createMipmaps(const unsigned char *const img,
        int width, int height, int channels,
        unsigned int flags,
        unsigned int opengl_texture_target,
...
P_SOIL_GLCOMPRESSEDTEXIMAGE2DPROC get_glCompressedTexImage2D_addr();
};
//#ifdef __cplusplus
//}
//#endif
